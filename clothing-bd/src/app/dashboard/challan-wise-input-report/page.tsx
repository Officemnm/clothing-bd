    ...
    <div className="max-w-xl mx-auto">
      ...
      >
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">Challan Wise Input Report</h1>
            <p className="text-xs text-slate-500">Generate production input report from ERP</p>
          </div>
        </div>
      </motion.div>
